// WRITE registerfoodadmin() --> This gets triggered when button is clicked
var token = sessionStorage.getItem('token');



function registerfoodadmin() {
    ...
    $.ajax({
        ...
        success: function (res, textStatus, xmLHttpRequest) {
            if (res.exists === 'true') {
                ...
                $.ajax({
                    async: true,
                    url: "/api/v2/utility/registerfoodadmin",
                    method: "POST",
                    headers: {
                    ...
                    success: function (res, textStatus, xmLHttpRequest) {
                        swal({text : "Food Admin Registered Successfully.",closeOnClickOutside:false}).then(function(){
                            location.reload();
                        });
                    },
