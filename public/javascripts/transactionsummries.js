    ...
    $.ajax({
        ...
        success: function (res, textStatus, xmLHttpRequest) {
            ...
            for (let i = 0; i < res.list.length; i++) {
                ...
                stringToAppend.push([val.transactionID, val.amount, val.cardNo, val.phoneNumber, date.toDateString(), date.toTimeString().split(' ')[0]]);
            }
