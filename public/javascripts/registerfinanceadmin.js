// WRITE registerfinanceadmin() --> This gets triggered when button is clicked
var token = sessionStorage.getItem('token');



function registerfinanceadmin() {
    ...
    $.ajax({
        ...
        success: function (res, textStatus, xmLHttpRequest) {
            if (res.exists === 'true') {
                ...
                $.ajax({
                    async: true,
                    url: "/api/v2/utility/registerfadmin",
                    method: "POST",
                    headers: {
                    ...
                    success: function (res, textStatus, xmLHttpRequest) {
                        swal({text : "Finance Admin Registered Successfully.",closeOnClickOutside:false}).then(function(){
                            location.reload();
                        });
                    },
