...
(function(h) {
    ...
    function Ha(a, b, c, d) {
        ...
        //Some contribution from our side, for opening modal..
        e.nTr.setAttribute('data-toggle',"modal");
        e.nTr.setAttribute('data-target',"#myModal");
        e.nTr.setAttribute('onClick','query(this)');
    ...
    function qb(a) {
        var b = a.oClasses,
            ...
            e = a.oPreviousSearch,
            f = a.aanFeatures,
            g = '<input id="text-color" type="search" class="' + b.sFilterInput + '"/>',
            j = d.sSearch,
